...
function shouldLog(level: LogLevel): boolean {
    ...
    const currentLevelPriority = LOG_LEVEL_PRIORITY[normalizedLogLevel] ?? LOG_LEVEL_PRIORITY[LogLevel.INFO]
...
const SENSITIVE_FIELDS = [
    'id', 'user_id', 'userId', 'username', 'email', 'password', 'token', 
    'jwt', 'secret', 'key', 'phone', 'address', 'ip', 'studentId',
    'originalRole', 'mappedRole', 'decoded'
]
